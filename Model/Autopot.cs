...
namespace _4RTools.Model
{
    ...
    public class Autopot : Action
    {
        ...
        private void pot(Client roClient, Key key)
        {
            if (roClient == null || !roClient.IsGameActive()) { return; }
            ...
            {
                Interop.PostMessage(roClient.process.MainWindowHandle, Constants.WM_KEYDOWN_MSG_ID, k, 0); // keydown
                Interop.PostMessage(roClient.process.MainWindowHandle, Constants.WM_KEYUP_MSG_ID, k, 0); // keyup
            }
        }
