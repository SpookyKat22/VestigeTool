...
namespace _4RTools.Model
{
    ...
    public class Client
    {
        ...
        public byte[] ReadBytes(int address, uint bytesToRead)
        {
        ...
        public bool IsGameActive()
        {
            return this.process != null
                && this.process.MainWindowHandle != IntPtr.Zero
                && Utils.Interop.GetForegroundWindow() == this.process.MainWindowHandle;
        }
